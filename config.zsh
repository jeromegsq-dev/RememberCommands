...
REMEMBERCOMMANDS_API_URL="${REMEMBERCOMMANDS_API_URL:-https://codestral.mistral.ai/v1/chat/completions}"
REMEMBERCOMMANDS_MODEL="${REMEMBERCOMMANDS_MODEL:-codestral-latest}"
